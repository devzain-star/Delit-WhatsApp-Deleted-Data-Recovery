package com.recover.deleted.messages.chat.recovery.sqlite
...
{
    companion object {
        private const val DATABASE_NAME = "Status Saver"
    ...
    fun getAllData(): List<ContactModel> {
        ...
        while (!cc.isAfterLast) {
            ...
            arrayList.add(bean)
            Log.i(TAG,"Logo:"+ cc.getString(cc.getColumnIndex(KEY_CONTACT_LOGO)))
            cc.moveToNext()
        }
        db.close()
        return arrayList
